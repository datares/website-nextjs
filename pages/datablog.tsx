...
import datablog1 from '../public/Assets/DataBlog/datablog1.png';
import datablog2 from '../public/Assets/DataBlog/datablog2.png';
import datablog3 from '../public/Assets/DataBlog/datablog3.jpg';
import datablog4 from '../public/Assets/DataBlog/datablog4.png';
import datablog5 from '../public/Assets/DataBlog/datablog5.png';
import datablog6 from '../public/Assets/DataBlog/datablog6.jpg';
import datablog7 from '../public/Assets/DataBlog/datablog7.png';
import datablog8 from '../public/Assets/DataBlog/datablog8.png';
import datablog9 from '../public/Assets/DataBlog/datablog9.png';
import datablog10 from '../public/Assets/DataBlog/datablog10.png';
import datablog11 from '../public/Assets/DataBlog/datablog11.png';
import datablog12 from '../public/Assets/DataBlog/datablog12.png';
        ...
        <div style={{backgroundColor: '#333b65', color: 'white'}}>
                <Container style={{paddingTop: '10%'}}>
                    <Grid>
                        <Grid.Row columns={2}>
                            <Grid.Column width={7}>
                                <Image src={blogImage} alt='data blog image' width={500} />
                            </Grid.Column>
                            <Grid.Column width={9}>
                                <div>
                                ...
                                <p style={{color: "white", fontSize: '1.75em', maxWidth: '100%', paddingTop: '1%'}}>
                                    ...
                                    the analytical insights we have unearthed.
                                </p>
                            </Grid.Column>
                        </Grid.Row>
                    </Grid>
            ...
            <div>
                <Container style={{paddingBottom: '10%'}}>
                    <Container fluid>
                        <div style={{fontSize: '2em', marginBottom: '5%', marginTop: '5%'}}>
                            <h1 style={{color: "white", fontSize: '1.2em'}}>Latest DataBlog Articles</h1>
                        </div>
                    </Container>
                    <div style={{paddingTop: '2%'}} className={styles.Gallery}>
                            {Articles.map((article, idx) => (
                                <Container className={styles.card_body} key={idx}>
                                    <a href={article.url} rel="noopener noreferrer" target="_blank">
                                    <Segment className={styles.segment_body} size="big" onClick={() => {}}>
                                        <Image src={article.image} alt='image' width={400} />
