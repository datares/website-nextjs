...
const About = () => {
    return (
        <div style={{backgroundColor: "#333b65", paddingBottom: '10%'}}>
            ...
            <div style={{ textAlign: 'left', paddingTop: '10%', paddingLeft: '20%', color: "white"}}>
                <Header style={{fontSize: '3em', color: "white"}}>How do I join?</Header>
                <p style={{fontSize: '1.5em', maxWidth: "60%"}}>Each of our teams recruits on a quarterly basis, with applications opening around the beginning of week 1</p>
            </div>
